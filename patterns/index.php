...
<div class="wp-block-group hero-text-content" style="padding-right:120px"><!-- wp:heading {"className":"hero-heading","style":{"typography":{"fontSize":"72px","lineHeight":"1.2"}}} -->
<h2 class="wp-block-heading hero-heading" style="font-size:72px;line-height:1.2">We are a worldwide design agency <mark style="background-color:rgba(0, 0, 0, 0);color:#eb6945" class="has-inline-color">increase conversion...</mark></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"hero-text","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
<p class="hero-text" style="margin-top:0;margin-bottom:0">We are a strategic partner for fast-growing tech companies in need of a scalable&nbsp;website.We are a strategic partner for fast-growing tech companies in need of a scalable&nbsp;website.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"className":"success-text"} -->
<p class="success-text">Clients</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"className":"success-item","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group success-item"><!-- wp:heading {"className":"success-heading"} -->
<h2 class="wp-block-heading success-heading">One Billion+</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"success-text"} -->
<p class="success-text">Lives Touched</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"className":"success-item","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group success-item"><!-- wp:heading {"className":"success-heading"} -->
<h2 class="wp-block-heading success-heading">30+</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"success-text"} -->
<p class="success-text">Global Awards</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:group {"metadata":{"name":"promo video"},"className":"promo-video","layout":{"type":"default"}} -->
<div class="wp-block-group promo-video"><!-- wp:embed {"url":"https://youtu.be/uOHOgI66C28?si=OkGMaQmaC6mBAnI4","type":"video","providerNameSlug":"youtube","responsive":true,"className":"wp-embed-aspect-16-9 wp-has-aspect-ratio"} -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/logo-discord.png" alt="" class="wp-image-153"/></figure>
<!-- /wp:image -->

<!-- wp:image {"id":158,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/logo-monday.png" alt="" class="wp-image-158"/></figure>
<!-- /wp:image -->

<!-- wp:image {"id":157,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/logo-gumroad.png" alt="" class="wp-image-157"/></figure>
<!-- /wp:image -->

<!-- wp:image {"id":159,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/logo-pipe.png" alt="" class="wp-image-159"/></figure>
<!-- /wp:image -->

<!-- wp:image {"id":151,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/logo-attentive.png" alt="" class="wp-image-151"/></figure>
<!-- /wp:image -->

<!-- wp:image {"id":152,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/logo-cult.png" alt="" class="wp-image-152"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/logo-plaid.png" alt="" class="wp-image-160"/></figure>
<!-- /wp:image -->

<!-- wp:image {"id":156,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/logo-github.png" alt="" class="wp-image-156"/></figure>
<!-- /wp:image -->

<!-- wp:image {"id":161,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/logo-square.png" alt="" class="wp-image-161"/></figure>
<!-- /wp:image -->

<!-- wp:image {"id":154,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/logo-farmer.png" alt="" class="wp-image-154"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/logo-ghost.png" alt="" class="wp-image-155"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-full bg-why-us-item-right"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/bg-why-us-item-1.png" alt="" class="wp-image-179"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/icon-dollor.png" alt="" class="wp-image-209"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full bg-why-us-item-right"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/bg-why-us-item-2.png" alt="" class="wp-image-181"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full bg-why-us-item-right"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/bg-why-us-item-3.png" alt="" class="wp-image-189"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/services-vector-warp.png" alt="" class="wp-image-222"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-full cta-img-right-top"><img src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/cta-img-right-top.png" alt="" class="wp-image-247"/></figure>
<!-- /wp:image -->
