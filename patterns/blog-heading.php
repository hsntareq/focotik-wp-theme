...
<!-- wp:paragraph {"style":{"color":{"text":"#d6d8dc"},"elements":{"link":{"color":{"text":"#d6d8dc"}}}},"fontSize":"small"} -->
<p class="has-text-color has-link-color has-small-font-size" style="color:#d6d8dc">Whether your product needs a fresh look, better user experience, or enhanced functionality, our product redesign agency is here to help. Achieve your goals with a revamped product.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group gap12"><!-- wp:post-title {"level":5,"isLink":true,"style":{"typography":{"lineHeight":"1.25","letterSpacing":"-0.02em"},"color":{"text":"#383a3e"},"elements":{"link":{"color":{"text":"#383a3e"}}}}} /-->
