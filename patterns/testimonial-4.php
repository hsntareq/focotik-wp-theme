...
<div class="wp-block-group has-background testimonial-4" style="background-color:#181a1d;margin-top:0;margin-bottom:0"><!-- wp:group {"metadata":{"name":"container"},"style":{"spacing":{"padding":{"top":"180px","bottom":"180px"}}},"layout":{"type":"constrained","wideSize":"1170px"}} -->
<div class="wp-block-group" style="padding-top:180px;padding-bottom:180px"><!-- wp:heading {"className":"main-heading","style":{"typography":{"lineHeight":"1.2","letterSpacing":"-0.035em"},"color":{"text":"#eff2f6"},"elements":{"link":{"color":{"text":"#eff2f6"}}}},"fontSize":"3x-large"} -->
<h2 class="wp-block-heading main-heading has-text-color has-link-color has-3-x-large-font-size" style="color:#eff2f6;letter-spacing:-0.035em;line-height:1.2">Still not convinced?<br>See <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-hover-color">how it works</mark></h2>
<!-- /wp:heading -->
