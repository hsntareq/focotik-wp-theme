...
<!-- wp:group {"className":"testimonial-4","metadata":{"name":"Testimonial 4"},"style":{"color":{"background":"#181a1d"},"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group has-background testimonial-4" style="background-color:#181a1d;margin-top:0;margin-bottom:0"><!-- wp:group {"metadata":{"name":"container"},"layout":{"type":"constrained","wideSize":"1170px"}} -->
<div class="wp-block-group"><!-- wp:heading {"className":"main-heading","style":{"typography":{"lineHeight":"1.2","letterSpacing":"-0.035em"},"color":{"text":"#eff2f6"},"elements":{"link":{"color":{"text":"#eff2f6"}}}},"fontSize":"3x-large"} -->
<h2 class="wp-block-heading has-text-color has-link-color has-3-x-large-font-size main-heading" style="color:#eff2f6;letter-spacing:-0.035em;line-height:1.2">Still not convinced?<br>See <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-hover-color">how it works</mark></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group has-background testimonial-4-item" style="border-top-left-radius:24px;border-bottom-left-radius:24px;background-color:#f6f9fd;padding-top:46px;padding-right:74px;padding-bottom:50px;padding-left:44px"><!-- wp:heading {"style":{"typography":{"lineHeight":"1.34","letterSpacing":"-0.02em"}},"fontSize":"large"} -->
