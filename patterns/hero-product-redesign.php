...
<?php
/**
 * Title: hero product redesign
 * Slug: focotik/hero-product-redesign
 * Inserter: no
 */
?>
<!-- wp:group {"metadata":{"name":"hero product redesign"},"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"108px","bottom":"108px"}},"color":{"background":"#181a1d"}},"layout":{"type":"default"}} -->
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:group {"className":"hero-redesign","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"right":"0","left":"0"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
<div class="wp-block-group hero-redesign" style="margin-top:0;margin-bottom:0;padding-right:0;padding-left:0"><!-- wp:group {"layout":{"type":"constrained","wideSize":"553px","justifyContent":"left"}} -->
...
<p class="has-text-color has-link-color has-small-font-size" style="color:#d6d8dc;margin-top:var(--wp--preset--spacing--40);margin-bottom:2rem">Whether your product needs a fresh look, better user experience, or enhanced functionality, our product redesign agency is here to help. Achieve your goals with a revamped product.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-font-size has-medium-font-size" style="font-style:normal;font-weight:400;letter-spacing:-0.01em;line-height:1.4"><a class="wp-block-button__link wp-element-button">Imporve my product <img class="wp-image-1309" style="width: 24px;" src="<?php echo esc_url(FOCOTIK_THEME_URI) ?>assets/images/arrow.png" alt=""></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
